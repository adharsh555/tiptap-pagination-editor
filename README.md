...
Calculating page breaks in a web-based rich text editor is non-trivial because the DOM is naturally a continuous scroll. My approach simulates a true word-processor layout engine.
...
To prevent horizontal clipping (where a line is cut in half horizontally), I implemented a backtracking logic:
